...
const page = () => {
  return (
    <div className="bg-[#E9E2DB] min-h-screen overflow-x-hidden">
      <div className="max-w-[1320px] mx-auto px-[1.5rem] sm:px-[2rem] pt-4 mb-10 idkk">
        <ArrowLink color="black" />
        <div className="grid-cols-12 gap-2 hidden xl:grid mt-4">
          <AiirlabsHeader />
          <AiirlabsPromo1 />
          ...
          <div className="bg-[#D3D3C9] rounded-lg col-span-3 h-[20rem] p-6">
            ...
            <p className="xl:text-[0.95rem] xxl:text-[1.05rem]">
              ...
              picture, which will be automatically updated within any
              discussions. Additionally users can easily bookmark their favorite
              coins and stay updated on their performance.
            </p>
          </div>
          <AiirlabsPromo2 />
          <MacBook />
          <div className="bg-[#D3D3C9] rounded-lg col-span-5 h-[20rem] p-6">
            ...
            <p className="xl:text-[0.95rem] xxl:text-[1.05rem] pr-12">
              When a user receives a reply on one of their comments, they will
              be notified in real-time. A red notification symbol will appear
              next to the bell icon, and a blue dot will indicate an unread
              notification within the notification dropdown. Clicking on the
              notification will take the user directly to the reply, which will
              be highlighted briefly for easy identification.
            </p>
          </div>
          <div className="bg-[#D3D3C9] rounded-lg col-span-6 h-[20rem] p-6">
            ...
            <p className="xl:text-[0.95rem] xxl:text-[1.05rem] pr-12">
              ...
              discussion section where users can share their thoughts and
              opinions. The section features a filter system that allows users
              to view the most upvoted comments or the latest ones. When
              replying to a comment that is not a top-level one, a &quot;@&quot;
              symbol followed by the username will be added to the start of the
              reply. This helps to organize the conversation and ensures that
              the relevant parties are notified of the response.
            </p>
          </div>
