...
const Contact = () => {
  return (
    <SectionLayout sectionName="Contact">
      <div className="relative max-w-[800px] mx-auto my-10">
        <picture>
          <img
            src="/laptop.svg"
            alt="laptop"
        ...
        <div className="relative bg-[#FFE5D4] h-[12rem] rounded-lg mx-4 overflow-hidden flex p-6">
          ...
          <div className="relative w-[40%] flex items-center justify-center sm:mx-6">
            <button
              title="send email"
              className="flex items-center justify-center border-2 border-[#FF754F] bg-[#ff754f] hover:bg-[#ffe5d4] hover:text-[#ff754f] py-2 w-[8rem] text-white rounded-md"
            >
              Say hi!
            </button>
          </div>
