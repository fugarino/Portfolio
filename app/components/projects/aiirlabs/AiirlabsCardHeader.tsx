...
const AiirlabsCardHeader = () => {
  return (
    <header className="w-full flex justify-between">
      ...
      <div className="hidden xl:flex w-[44%] xxl:w-[40%] justify-between text-[#00000088]">
        <div className="pl-2 flex space-x-2">
          <a
            ...
            aria-label="aiirlabs"
            className="w-[24px] h-[24px] hover:text-black"
          >
            <svg
...
export default AiirlabsCardHeader;
