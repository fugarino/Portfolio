  ...
  return (
    ...
    >
      <div className="h-full flex flex-col xl:flex-row">
        <div className="w-full h-[65%] sm:h-[68%] xl:h-auto xl:w-1/2 p-1 sm:p-[6px] xl:p-2">
          <Link href="/aiirlabs">
        ...
        <div className="relative w-full h-[35%] sm:h-[32%] xl:h-auto xl:w-1/2 p-4 sm:p-4 xl:p-8 xl:pb-0 flex flex-col justify-between">
          {/* <div className="hidden xl:flex absolute -top-1 xl:right-6 xxl:right-10 w-[14rem]">
            <picture>
              <img src="/iPhone XR.png" alt="mockup" />
            </picture>
          </div> */}
          <div className="w-full">
            ...
            {/* <p className="xl:mt-4 xxl:mt-7 text-[0.9rem] xl:w-[60%] xxl:w-[65%] text-[#434343] hidden xl:block">
              aiirlabs provides a range of features, including{" "}
              ...
              , the ability to engage with the community through{" "}
              <span className="text-black font-medium underline">comments</span>
              ,{" "}
              <span className="text-black font-medium underline">
                up/downvoting
              </span>
