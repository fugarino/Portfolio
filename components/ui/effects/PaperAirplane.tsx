  ...
  return (
    ...
    >
      <g id="Layer_3">
        ...
        <path
          className={`${styles.planeDarkblue}`}
          d="M401.7 563.2c-7.5 0-14.6-4.5-17.5-11.9-3.8-9.7 1-20.5 10.7-24.3L1687.5 22.4c9.7-3.8 20.5 1 24.3 10.7 3.8 9.7-1 20.5-10.7 24.3L408.5 561.9c-2.2.9-4.5 1.3-6.8 1.3z"
        />
        <path
          className={`${styles.planeDarkblue}`}
          d="M422.6 871.8c-6.3 0-12.4-3.1-16-8.9-5.5-8.8-2.8-20.4 6.1-25.8L1655.3 66c8.8-5.5 20.4-2.8 25.8 6 5.5 8.8 2.8 20.4-6 25.8L432.5 868.9c-3.1 2-6.5 2.9-9.9 2.9z"
        />
      </g>
    </svg>
  );
